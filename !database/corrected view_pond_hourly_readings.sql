...
) ENGINE=InnoDB AUTO_INCREMENT=38 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='INTENSIVE\r\nSEMI-INTENSIVE\r\nTRADITIONAL';
...
CREATE TABLE `view_pond_hourly_readings` (
	...
	`ammonia` DOUBLE NULL,
	`tds` DOUBLE NULL,
	`recorded_at_start` VARCHAR(24) NULL COLLATE 'utf8mb4_0900_ai_ci'
) ENGINE=MyISAM;
