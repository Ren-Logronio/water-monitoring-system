...
export default function DaterangePopover({ children, asChild = false, onChange, disabled = false }: { disabled?: boolean, children?: React.ReactNode, asChild?: boolean, onChange?: (dateFrom: Date, dateTo: Date, mode: string) => void }) {
    ...
    return <Popover>
        <PopoverTrigger disabled={disabled}>
            <div className="border py-1 px-3 bg-white rounded-md flex flex-row items-center space-x-2 text-[14px] max-w-[856px]">
